...
/**
 * Activity — the canonical consolidation of Threads (canon 04 §1.1).
 *
 ...
 * (INV-DM-1). Renaming Threads to Activity changes the information
 * architecture, not the contact rules.
 */
